    ...
    <div className={s.desktopWrap}>
      {open && (
        <div className={s.desktopMenu}>
          <a
            className={s.desktopMenuItem}
            href={whatsappUrl(lp.whatsapp, lp.whatsappMessage)}
            target="_blank"
            rel="noopener noreferrer"
          >
            <WaIcon color="var(--brand-orange)" />
            <span>
              <strong>La Plata</strong>{' '}
              <span className={s.menuMuted}>· Delivery</span>
            </span>
          </a>
          <a
            className={`${s.desktopMenuItem} ${s.desktopMenuItemBorder}`}
          ...
          >
            ...
            <span>
              <strong>Citybell</strong>{' '}
              <span className={s.menuMuted}>· Take away</span>
            </span>
          </a>
        </div>
      )}
      ...
      >
        ...
        <span className={s.chevron} style={{ transform: open ? 'rotate(180deg)' : undefined }}>▾</span>
      </button>
    </div>
  );
}
    ...
    <div className={s.mobileWrap}>
      {open && (
        <div className={s.mobileSheet}>
          ...
          >
            <WaIcon color="var(--brand-orange)" />
            <span className={s.mobileItemText}>
              <span className={s.mobileItemLabel}>WHATSAPP</span>
              <span className={s.mobileItemName}>La Plata</span>
              <span className={s.mobileItemSub}>Casco · Delivery</span>
            </span>
          </a>
          <a
            className={`${s.mobileItem} ${s.mobileItemBorder}`}
            href={whatsappUrl(cb.whatsapp, cb.whatsappMessage)}
            target="_blank"
            rel="noopener noreferrer"
          >
            ...
            <span className={s.mobileItemText}>
              <span className={s.mobileItemLabel}>WHATSAPP</span>
              <span className={s.mobileItemName}>Citybell</span>
              <span className={s.mobileItemSub}>Take away</span>
            </span>
          </a>
        </div>
      )}
      <button
        className={s.mobilePill}
        onClick={() => setOpen((o) => !o)}
        aria-expanded={open}
        aria-label="Pedí por WhatsApp"
      >
        <WaIcon size={18} />
        <span>{open ? 'Elegí sucursal' : 'Pedí por WhatsApp'}</span>
        <span className={s.chevron} style={{ transform: open ? 'rotate(180deg)' : undefined }}>▾</span>
      </button>
    </div>
  );
